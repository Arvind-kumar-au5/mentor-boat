      ...
      <section className="container">
          <div className="row">
              ...
              <div className="col-lg-6 col-md-6 col-xs-12 mt-5">
                <div className="row">
                  ...
                  <div className="col-lg-12 col-md-12 col-xs-12 mt-2">
                      <span className="font-weight-300" style={{fontSize:'30px'}}>Make your JEE/GATE preparations easy with <span className="text-primary">Mentor-Boat </span></span>
                  </div>
                  <br/>
                  <br/>
                  <div className="col-lg-12 col-md-12 col-xs-12 mt-2">
                        <span className="font-weight-300" style={{fontSize:'18px',color:'gray'}}>work 1 to1 with your personal mentor contomized plan according to your preparation level </span>
                  </div>
                  <br/>
                  <br/>
                  <br/>
              ...
              <div className="col-lg-4 col-md-4 col-xs-12 ">
                  <h2 className="text-primary" style={{textAlign:"center"}}>How Will We Help You</h2>
              </div>
              <div className="col-lg-4 col-md-4 col-xs-12 "></div>
              <br/>
              <br/>
              ...
              <div className="col-lg-6 col-md-6 col-xs-12 ">
                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-xs-12 ">
                      <h3 style={{fontSize:'36px',color:'#454545'}}>Work 1-to-1 with your own Personal JEE/GATE Mentor</h3>
                    </div>
                    <div className="col-lg-12 col-md-12 col-xs-12 ">
                      <p style={{fontSize:'18px',fontFamily:'robot'}}>
                      Things can get stressful around the dinner table for an aspirant, 
                      and it is thus necessary to have someone to rely on. 
                      My JEE Mentor connects you with previous years’ toppers who’ll motivate and guide you throughout your JEE preparations, both on an academic and a personal level. 
                      You can call or text your mentor anytime you want, and they’ll always be there to help you out!
                      </p>
                    </div>
                    <div className="col-lg-12 col-md-12 col-xs-12 ">
                      <Link to='/mentor/find' className='btn btn-primary' style={{width:'140px'}}>
                            Find Mentor
                        </Link>  
                    </div>
                </div>
              ...
              <br/>
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-xs-12 ">
                      <h3 style={{fontSize:'36px',color:'#454545'}}>Recieve a custom roadmap to cover your syllabus</h3>
                    </div>
                    <div className="col-lg-12 col-md-12 col-xs-12 ">
                      <p style={{fontSize:'18px',fontFamily:'robot'}}>
